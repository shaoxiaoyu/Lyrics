...
class Model(object):
    ...
    def build_inputs():
        ...
        return encode, decode_topic_label, decode_sen_input, decode_sen_label, encode_length, decode_sen_length
    ...
    def build_decoder_sen(self, decode_emb, length, state, scope='next_sen_decoder', reuse=False):
    ...
    def build(self, train=True):
        # input placeholder
        encode, decode_topic_label, decode_sen_input, decode_sen_label, encode_length, decode_sen_length = self.build_inputs()

        # embedding
        encode_emb, decode_sen_input_emb = self.build_word_embedding(encode, decode_sen_input)

        # build encoder
        initial_state, final_state = self.build_encoder(encode_emb, encode_length, train=train)
        ...
        decode_sen_logits, decode_sen_prediction, decode_sen_state = self.build_decoder_sen(decode_sen_input_emb,
                                                                                            decode_sen_length,
                                                                                            final_state,
                                                                                            scope='decoder_sen',
                                                                                            reuse=False
        ...
        decode_sen = {'decode_sen_optimizer': decode_sen_optimizer,
                      ...
                      'decode_sen_logits': decode_sen_logits
                      }
